...
class MenuAdapter (listMain: ArrayList<Dish>, contextM: Context) : RecyclerView.Adapter<MenuAdapter.MyHolder>() {
    ...
    fun removeItem(pos:Int, dbManager: MyDbManager){
        dbManager.removeMenu(listArray[pos].DishID.toString())
